...
const up = new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("assets/textures/environment/sk_top.png"), side: THREE.BackSide });
const sd = new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("assets/textures/environment/sk_side.png"), side: THREE.BackSide });
const dn = new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("assets/textures/environment/sk_bottom.png"), side: THREE.BackSide });
